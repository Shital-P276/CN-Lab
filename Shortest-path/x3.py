...
def dijkstra(graph, start_vertex, vertices):
    ...
    while unvisited_vertices:
        ...
        # If the minimum distance is infinity, break out of the loop (all remaining vertices are unreachable)
        ...
        for neighbor, weight in graph[min_vertex].items():
            if neighbor in unvisited_vertices and weight != float('inf'):  # Skip if no edge
